...
Feature: Accessing LAPs account - Journey4_HoF - Standard user - Non Wales_Unconfirmed Bank Details
...
#LAPS-216 - IDM Sign In  
    ...
    When I enter the email address for "HOF_Unconfirmed"
...
#LAPS-160 
    Then I am on the "Local Authority Payments (LAPs) home" page
    Then I validate warning text "Please confirm your local authority" is displayed on the page
    When I click "Cymraeg" link
